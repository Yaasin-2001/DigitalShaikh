  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      <div className='flex items-center rounded-md'>
        <img src="../images/shaikh_logo.png" alt="Digital Shaikh" className="mr-5" style={{ width: '332px', height: '179px' }} />
        {/* {siteInfo.title} {t('app.common.welcome')}*/}
      </div>
    </div>
  )
}
...
export const ChatBtn: FC<{ onClick: () => void; className?: string }> = ({
  ...
  return (
    <Button
      type='primary'
      className={cn(className, ` flex items-center ${s.customBtn}`)}
      onClick={onClick}>
